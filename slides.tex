...
\begin{frame}
	...
	\begin{flushleft}
		...
		from Rob Pike, Andrew Gerrand, Francesc Campoy Flores, and others from the
		Go community.
	\end{flushleft}
...
\begin{frame}
	...
	\end{fancyquote}
	\begin{tikzpicture}[remember picture,overlay]
		\node [xshift=-7em,yshift=-7em] at (current page.center)
		{\includegraphics[width=2em]{images/gophersimple.jpg}};
	\end{tikzpicture}
\end{frame}
